...
- [x] Correct `defaultRegistryId` versus backend `defaultPushRegistryId` in `caprover-api` ([SDK PR #17](https://github.com/caprover/caprover-api/pull/17)).
- [x] Publish and consume the corrected `caprover-api@0.0.25` package.
...
- [x] Verify container and proxied endpoint.
